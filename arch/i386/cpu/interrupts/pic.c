...
void remap_pic_irq()
{
	...
	outb8(I386_MASTER_REG_DATA,IRQ_START); //0x20 = 32
	outb8(I386_SLAVE_REG_IMR,IRQ_END); //0x28 = 47

	outb8(I386_MASTER_REG_DATA,I386_PIC_ICW2_IRQLINE_PRIMARY_IR2); //0x04 = 0100
	outb8(I386_SLAVE_REG_IMR ,I386_PIC_ICW2_IRQLINE_SECONDARY_IR2); //0x02 = 010
